// ═══════════════════════════════════════════════════════════
// 🔥 FIREBASE — FitTrack V2 (F0)
// Proyecto: fittrack-e06be (EL MISMO del app viejo, sin migrar)
// Patrón idéntico a RiderTrack V2: init modular Firebase 10,
// long polling dentro del APK (mejor performance en Android),
// y funciones de auth listas para que F1 las cable a la vista.
// En F0 el login es solo la vista: nadie llama a estas funciones
// todavía, pero quedan compiladas y exportadas.
// ═══════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════
// 🔐 AUTENTICACIÓN (se cablean en F1)
// ═══════════════════════════════════════════════════════════
